...
export default withApiAuthRequired(async function services(req, res) {
  try {
    ...
    let nameIdentifier = "auth0|5faa8e592bb2660070ddb75c";
    let firstName = "John";
    let lastName = "Wilson";

    const response = await fetch(`https://si1bxg1832.execute-api.eu-west-1.amazonaws.com/userprofile?nameIdentifier=${nameIdentifier}&firstName=${firstName}&lastName=${lastName}`, {
      method: 'POST',
      headers: {
